...
internal static class OpCodes {
    private static readonly Action[] OpCodeSolvers = [
            ...
            /* 18 clc */ () => { Register.c = false; cycle = 0;},
            ...
            /* 38 sec */ () => { Register.c = true; cycle = 0; },
            ...
            /* 48 pha     */ () => { Data = Register.AC; Memory.Push(); cycle = 0;},
            ...
            /* 58 cli */ () => { Register.i = false; cycle = 0; },
            ...
            /* 68 pla     */ () => { Memory.Pull(); Register.AC = Data; cycle = 0; },
            ...
            /* 78 sei     */ () => { Register.i = true; cycle = 0; },
            ...
            /* 88 dey     */ () => { Register.Y--; cycle = 0; NonArithmeticProcessorFlagSets(Register.Y);},
            /* 89 nop #   */ () => Immediate(() => { }),
            /* 8a txa     */ () => { Register.AC = Register.X; cycle = 0; NonArithmeticProcessorFlagSets(Register.AC); },
            ...
            /* 98 tya     */ () => { Register.AC = Register.Y; cycle = 0; NonArithmeticProcessorFlagSets(Register.AC); },
            /* 99 sta a+y */ () => AbsoluteIndexed(Register.Y, STA),
            /* 9a txs     */ () => { Register.S  = Register.X; cycle = 0; },
            ...
            /* a8 tay      */ () => { Register.Y = Register.AC; cycle = 0; NonArithmeticProcessorFlagSets(Register.Y); },
            /* a9 lda #imm */ () => Immediate(LDA),
            /* aa tax      */ () => { Register.X = Register.AC; cycle = 0; NonArithmeticProcessorFlagSets(Register.X); },
            ...
            /* b8 clv     */ () => { Register.v = false; cycle = 0; },
            /* b9 lda a,x */ () => AbsoluteIndexed(Register.X, LDA),
            /* ba tsx     */ () => { Register.X = Register.S; cycle = 0; NonArithmeticProcessorFlagSets(Register.X); },
            ...
            /* c8 iny     */ () => { Register.Y++; cycle = 0; NonArithmeticProcessorFlagSets(Register.Y); },
            /* c9 cmp #   */ () => Immediate(CMP),
            /* ca dex     */ () => { Register.X--; cycle = 0; NonArithmeticProcessorFlagSets(Register.X); },
            ...
            /* d8 cld     */ () => { Register.d = false; cycle = 0; },
            ...
            /* e8 inx     */ () => { Register.X++; cycle = 0; NonArithmeticProcessorFlagSets(Register.X);},
            ...
            /* f8 sed     */ () => { Register.d = true; cycle = 0; },
